...
function Download_ConvertFromDem(type, vDem, vZRate, vDistance){
    ...
    var vDemZ      = modelSizeN / vDistance;		          // Length on the model per DEM of 1m(mm) (Height direction) == scale
